...
<fieldset>
  <legend>Profile</legend>
    ...
    <div class="col-sm-4"><asp:TextBox CssClass="form-control unicase-form-control text-input" ID="TextBox1" runat="server"></asp:TextBox>
              </div>

    <div class="col-sm-2">UDIO MOBILE NO. <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
