...
<fieldset>
  <legend>Change Password</legend>
    ...
    <div class="row">
    <div class="col-sm-6">Old Password <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage="Enter Old Password" 
                    ValidationGroup="aa">*</asp:RequiredFieldValidator></div>
    <div class="col-sm-6"><asp:TextBox CssClass="form-control unicase-form-control text-input" ID="TextBox1" runat="server" 
                    TextMode="Password"></asp:TextBox></div>
    </div>
    </div>
    <div class="form-group">
    <div class="row">
    <div class="col-sm-6">New Password <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="TextBox2" ErrorMessage="Enter New Password" 
                    ValidationGroup="aa">*</asp:RequiredFieldValidator></div>
    <div class="col-sm-6"><asp:TextBox CssClass="form-control unicase-form-control text-input" ID="TextBox2" runat="server" 
                    TextMode="Password"></asp:TextBox></div>
    </div>
    </div>
    <div class="form-group">
    <div class="row">
    <div class="col-sm-6">Confirm Password <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
    ...
    <div class="col-md-6 col-md-offset-6">              
        <asp:Button CssClass="btn-upper btn btn-primary checkout-page-button" ID="Button1" runat="server" Text="Change Password" onclick="Button1_Click" 
                  ValidationGroup="aa" />      
    </div>
    </div>
    <div class="row">
